...
class Trainer:
    ...
    def __init__(self, network, x_train, t_train, x_test, t_test,
        ...
        self.batch_size = int(minibatch_size)
    ...
    def train(self):
        ...
        self.train_loss_list = np.array(self.train_loss_list)  # list 를 numpy array 로 바꾼다
        ...
        plt.plot(np.arange(0, self.epochs), self.train_loss_list, label="loss")  # cost 값을 그래프로 표시한다.
...
if __name__ == '__main__':
    ...
    parser.add_argument("--minibatch_size", required=False, default=100, help="mini_batch_size : default=100")
